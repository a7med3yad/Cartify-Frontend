const MerchantApp = (() => {
  ...
  function loadSubcategoryData(id) {
      ...
      <div class="modal fade" id="addMeasureByAttributeModal" tabindex="-1">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
              <button type="button" class="btn btn-primary" id="btnConfirmAddMeasureByAttribute">Add Measure to Attribute</button>
            </div>
          </div>
        </div>
      </div>
    `;
          ...
          // Load attributes for the dropdown
          const token = getAuthToken();
          if (token) {
            $.ajax({
              url: `${API_BASE_URL}/merchant/attributes-measures/attributes`,
        ...
        return {
          ...
          } // end success: function(data) for loadSubcategoryData
          ,
          error: function (xhr) {
      ...
      } // end function loadSubcategoryData
